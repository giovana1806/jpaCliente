...
@Tag(name = "Clientes", description = "API REST DE GERENCIAMETO DE CLIENTES") 
@RestController  
...
public class ClienteController {  
	...
	public ResponseEntity<Cliente> alteraClientesControl(@PathVariable Long id, @RequestBody @Valid Cliente cliente){  
